        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-6 mb-6'>
          <div>
            ...
            <input
              ...
              className='input input-bordered w-full max-w-xs bg-transparent border border-gray-300 rounded focus:outline-none focus:ring-blue-500 focus:border-blue-500 text-white'
